...
def init_db():
    ...
    if count == 0:
        example_workspaces = [
            (
                "Downtown Loft Desk",
                "Modern desk space with fast Wi-Fi and great city view.",
                12.5,
                4.7,
                None,
                None,
            ...
            (
                "Creative Hub Meeting Room",
                "Bright meeting room ideal for workshops and client calls.",
                25.0,
                4.5,
                None,
                None,
            ...
            (
                "Quiet Focus Pod",
                "Soundproof pod for deep work and focus.",
                15.0,
                4.9,
                None,
                None,
